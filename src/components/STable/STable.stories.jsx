      ...
      render: h => (
        <StoryContainer>
          ...
          <STable>
            ...
            <STableRow>{slotContent}</STableRow>
          </STable>
      ...
      render: h => (
        <StoryContainer>
          ...
          <STable>
            ...
            <STableRow>
              <STableCell is-header={isHeader}>{headerCellSlotContent}</STableCell>
              <STableCell is-numeric={isNumeric}>{numericCellSlotContent}</STableCell>
            </STableRow>
          </STable>
